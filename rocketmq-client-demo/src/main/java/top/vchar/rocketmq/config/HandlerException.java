...
public class HandlerException implements ErrorWebExceptionHandler {
    ...
    private void storeErrorInformation(Throwable ex){
        ...
        if(ex instanceof WebExchangeBindException){
            ...
            Optional<ObjectError> errorOptional = bindException.getAllErrors().stream().findAny();
            body = ApiResponseBuilder.error(ApiCode.PARAM_ERROR, errorOptional.isPresent()?errorOptional.get().getDefaultMessage():"参数不正确");
